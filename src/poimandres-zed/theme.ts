...
function createTheme({ colors, styles }: Theme, themeName: string) {
  return {
    ...
    style: {
      ...
      'vim.normal.background': colors.desaturatedBlue,
      'vim.normal.foreground': colors.bg,
      'vim.helix_normal.background': colors.desaturatedBlue,
      'vim.helix_normal.foreground': colors.bg,
      'vim.visual.background': colors.pink,
      'vim.visual.foreground': colors.bg,
      'vim.helix_select.background': colors.pink,
      'vim.helix_select.foreground': colors.bg,
      'vim.insert.background': colors.brightMint,
      'vim.insert.foreground': colors.bg,
      'vim.visual_line.background': colors.pink,
      'vim.visual_line.foreground': colors.bg,
      'vim.visual_block.background': colors.pink,
      'vim.visual_block.foreground': colors.bg,
      'vim.replace.background': colors.hotRed,
      'vim.replace.foreground': colors.bg,
    },
  }
}
